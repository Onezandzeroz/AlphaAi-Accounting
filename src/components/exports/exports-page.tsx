...
export function ExportsPage({ user }: ExportsPageProps) {
  ...
  const exportVATReport = useCallback(() => {
    ...
    try {
      ...
      rows.push(['', language === 'da' ? 'Transaktioner' : 'Transactions', totals.count.toString(), '', '']);
    ...
    if (saftTotals.count === 0) {
      setSaftValidation({
        ...
        details: [{
          field: 'transactions',
          message: language === 'da' 
            ? 'Ingen transaktioner i den valgte periode. Vælg en anden måned eller tilføj transaktioner.'
  ...
  return (
    <div className="p-4 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <Download className="h-6 w-6 text-[#554fe9]" />
            {t('exports')}
          </h1>
      ...
      <Card className="stat-card border-0 shadow-lg dark:border dark:border-white/5">
        <CardContent className="p-4">
          <div className="flex items-center gap-4">
            <Calendar className="h-5 w-5 text-[#554fe9]" />
      ...
      <Card className="relative overflow-hidden border-2 border-[#554fe9]/20 dark:border-[#554fe9]/30 shadow-xl">
        <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#554fe9]/10 to-[#554fe9]/5 rounded-full blur-3xl transform translate-x-1/3 -translate-y-1/3" />
        <CardContent className="relative p-6">
          <div className="flex flex-col lg:flex-row lg:items-start gap-6">
            <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-[#554fe9] to-[#554fe9] flex items-center justify-center shrink-0 shadow-lg">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Badge className="bg-[#554fe9]/10 text-[#554fe9] border-[#554fe9]/20">
                  {t('officialFormat')}
                </Badge>
              </div>
                  ...
                  <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden bg-white">
                    <DialogHeader>
                      <DialogTitle className="flex items-center gap-2 text-xl dark:text-white">
                        <Shield className="h-5 w-5 text-[#554fe9]" />
                    ...
                    {saftStep === 'select' && (
                      <div className="space-y-6 py-4">
                        <div className="bg-gradient-to-br from-[#554fe9]/5 to-[#554fe9]/5 dark:from-[#554fe9]/10 dark:to-[#554fe9]/10 rounded-xl p-6 border border-[#554fe9]/20">
                          <h4 className="font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                            <Sparkles className="h-4 w-4 text-[#554fe9]" />
                            {t('readyToGenerate')}
                          </h4>
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                          <CheckCircle2 className="h-4 w-4 text-[#554fe9]" />
                          {t('compliantWith')}
                        </div>
                      </div>
                    )}
                    ...
                    {(saftStep === 'validating' || saftStep === 'generating') && (
                      <div className="space-y-6 py-8">
                        <div className="text-center">
                          <div className="inline-flex items-center justify-center h-16 w-16 rounded-full bg-gradient-to-br from-[#554fe9] to-[#554fe9] mb-4">
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              <div className="h-12 w-12 rounded-xl stat-icon-emerald flex items-center justify-center shrink-0">
                <FileSpreadsheet className="h-6 w-6 text-[#554fe9]" />
              </div>
              <div className="flex-1 min-w-0">
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              <div className="h-12 w-12 rounded-xl stat-icon-blue flex items-center justify-center shrink-0">
                <FileText className="h-6 w-6 text-[#7a76f0]" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-900 dark:text-white">
                  {t('vatReportCSV')}
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              <div className="h-12 w-12 rounded-xl stat-icon-violet flex items-center justify-center shrink-0">
                <Archive className="h-6 w-6 text-[#554fe9]" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-gray-900 dark:text-white">
                  {t('oioublInvoices')}
