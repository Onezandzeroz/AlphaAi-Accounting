...
const TYPE_TEXT_LIGHT: Record<string, string> = {
  ...
  EQUITY: 'text-[#554fe9] dark:text-[#7a76f0]',
...
const TYPE_ROW_BORDER: Record<string, string> = {
  ...
  EQUITY: 'border-l-[#554fe9] dark:border-l-[#7a76f0]',
...
function getGroupBadgeStyle(group: string): string {
  switch (group) {
    ...
    case 'INVENTORY':
    case 'FIXED_ASSETS':
      return 'bg-[#6a66f0]/10 text-[#554fe9] dark:bg-[#6a66f0]/20 dark:text-[#9b96f5] border-[#6a66f0]/20';
    case 'OTHER_ASSETS':
...
export function ChartOfAccountsPage({ user }: ChartOfAccountsPageProps) {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <BookOpen className="h-6 w-6 text-[#554fe9]" />
            {isDanish ? 'Kontoplan' : 'Chart of Accounts'}
          </h1>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Badge className="bg-[#554fe9]/10 text-[#554fe9] border-[#554fe9]/20 dark:bg-[#554fe9]/20 dark:text-[#7a76f0] dark:border-[#554fe9]/30 gap-1">
          ...
          <Button
            ...
            className="bg-[#554fe9] hover:bg-[#554fe9]/90 text-white gap-2 shadow-lg shadow-[#554fe9]/20 transition-all"
          >
      ...
      {accounts.length === 0 && !error ? (
        <Card className="stat-card border-0 shadow-lg dark:border dark:border-white/5">
          <CardContent className="py-16 text-center">
            <div className="inline-flex items-center justify-center h-20 w-20 rounded-2xl bg-gradient-to-br from-[#554fe9]/10 to-[#554fe9]/5 mb-6">
              <BookOpen className="h-10 w-10 text-[#554fe9] dark:text-[#7a76f0]" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-6">
              <Button
                onClick={handleSeed}
                disabled={isSeeding}
                className="bg-[#554fe9] hover:bg-[#554fe9]/90 text-white gap-2 shadow-lg shadow-[#554fe9]/20 transition-all px-6 py-6 text-base"
              >
                {isSeeding ? (
              ...
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="h-9 w-9 sm:h-12 sm:w-12 rounded-full stat-icon-primary flex items-center justify-center">
                    <BarChart3 className="h-4 w-4 sm:h-6 sm:w-6 text-[#554fe9] dark:text-[#7a76f0]" />
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select value={typeFilter} onValueChange={setTypeFilter}>
                    <SelectTrigger className="w-40 sm:w-48 bg-gray-50 border-0">
                    ...
                    <Card className={`stat-card border-0 shadow-lg dark:border dark:border-white/5 overflow-hidden border-l-4 ${TYPE_BORDER_COLOR[type] || ''} ${TYPE_BORDER_DARK[type] || ''}`}>
                      <CollapsibleTrigger asChild>
                        <button className="w-full">
                          <div className="flex items-center justify-between p-4 hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="text-left">
                                <div className="flex items-center gap-2 flex-wrap">
                                  ...
                                  {inactiveCount > 0 && (
                                    <Badge variant="outline" className="text-[10px] sm:text-xs font-normal text-gray-400 border-gray-200">
                      ...
                      <CollapsibleContent>
                        <div className="border-t border-gray-100/50">
                          ...
                          <div className="hidden md:grid md:grid-cols-12 gap-4 px-4 py-2.5 bg-gray-50/50 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                          ...
                          <div className="max-h-96 overflow-y-auto">
                            {typeAccounts.map((account) => (
                              <div
                                key={account.id}
                                className={`border-l-4 ${TYPE_ROW_BORDER[account.type] || ''} grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 px-4 py-3 border-b border-gray-50/30 last:border-b-0 hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors ${
                              ...
                              >
                                  ...
                                  <div className="flex items-center justify-between gap-2">
                                    ...
                                    <div className="flex items-center gap-1 shrink-0">
                                      {account.isActive ? (
                                        ...
                                        <Badge variant="outline" className="text-[10px] gap-1 text-gray-400 border-gray-200">
                                        ...
                                        <Tooltip>
                                          <TooltipTrigger asChild>
                                            <Button
                                              ...
                                              className="h-8 w-8 p-0 text-gray-400 hover:text-[#554fe9] dark:hover:text-[#7a76f0]"
                                            >
                                ...
                                <div className="hidden md:col-span-2 md:flex md:items-center">
                                  {account.isActive ? (
                                    ...
                                    <Badge variant="outline" className="text-[10px] sm:text-xs gap-1 text-gray-400 border-gray-200">
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription asChild>
              <div className="space-y-3 pt-2">
                ...
                <div className="flex items-start gap-2 text-sm text-gray-500 dark:text-gray-400 bg-gray-50 rounded-lg p-3">
                  <Shield className="h-4 w-4 shrink-0 mt-0.5 text-[#554fe9] dark:text-[#7a76f0]" />
                  <p>
                    {isDanish
      ...
      <DialogContent className="bg-white max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="dark:text-white flex items-center gap-2 text-xl">
            <div className="h-10 w-10 rounded-xl bg-[#554fe9]/10 flex items-center justify-center shrink-0">
              {mode === 'add' ? (
                <Plus className="h-5 w-5 text-[#554fe9] dark:text-[#7a76f0]" />
              ) : (
                <Pencil className="h-5 w-5 text-[#554fe9] dark:text-[#7a76f0]" />
              )}
            </div>
            {mode === 'add'
            ...
            {mode === 'edit' ? (
              <div className="flex items-center gap-2">
                <Input
                  ...
                  disabled
                  className="bg-gray-100 text-gray-500 dark:text-gray-400 cursor-not-allowed"
                />
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="h-10 w-10 rounded-lg bg-gray-100 flex items-center justify-center shrink-0 cursor-default">
