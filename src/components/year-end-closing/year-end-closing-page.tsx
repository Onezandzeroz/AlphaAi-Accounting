      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <CalendarDays className="h-6 w-6 text-[#554fe9]" />
            {isDanish ? 'Årsafslutning' : 'Year-End Closing'}
          </h1>
        ...
        <CardContent className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-[#554fe9] to-[#7a76f0] flex items-center justify-center shrink-0 shadow-lg">
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1 sm:max-w-[180px]">
                  <Input
                    ...
                    className="pr-8 bg-gray-50 border-0 text-lg font-semibold"
                  />
                </div>
                {/* Quick year buttons */}
                  ...
                  {[selectedYear - 1, selectedYear, selectedYear + 1]
                    ...
                    .map((y) => (
                      <Button
                        ...
                        className={
                          y === selectedYear
                            ? 'bg-[#554fe9] hover:bg-[#4a42d0] text-white min-w-[48px]'
        ...
        <Card className="relative overflow-hidden border-2 border-green-300 dark:border-green-800/50 shadow-xl">
          ...
          <CardContent className="relative">
            ...
            <div className="max-h-64 overflow-y-auto rounded-xl border border-gray-200">
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-50 hover:bg-gray-50 dark:hover:bg-white/5">
                ...
                <TableBody>
                  ...
                  {/* Totals row */}
                  <TableRow className="bg-gray-100 hover:bg-gray-100 dark:hover:bg-white/10 font-bold border-t-2 border-gray-300 dark:border-white/20">
            ...
            <div className="mt-4 flex justify-end">
              <Button
                ...
                className="gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white font-medium shadow-lg shadow-[#554fe9]/20 transition-all"
              >
              ...
              <CardContent className="p-3 sm:p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="h-9 w-9 sm:h-12 sm:w-12 rounded-full stat-icon-primary flex items-center justify-center">
                    <ClipboardCheck className="h-4 w-4 sm:h-6 sm:w-6 text-[#554fe9] dark:text-[#7a76f0]" />
                  </div>
                </div>
                <div className="mt-1.5 sm:mt-3 flex items-center text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                      ...
                      return (
                        <div
                          ...
                          className={`relative rounded-xl border p-3 sm:p-4 transition-all ${
                            isMissing
                              ? 'border-dashed border-gray-300 dark:border-white/20 bg-gray-50 opacity-60'
                              : isClosed
                                ? 'border-gray-200 bg-gray-50'
                                : isCurrentMonth
                                  ? 'border-[#554fe9]/40 dark:border-[#554fe9]/50 bg-[#554fe9]/5 dark:bg-[#554fe9]/10 shadow-md shadow-[#554fe9]/10'
                                  : 'border-gray-200 bg-white dark:bg-white/[0.02] hover:border-gray-300 dark:hover:border-white/15'
                          }`}
                        >
                          {isCurrentMonth && !isClosed && (
                            <div className="absolute -top-2 left-1/2 -translate-x-1/2">
                              <Badge className="bg-[#554fe9] text-white text-[10px] px-2 py-0 shadow-md">
                    ...
                    <div className="max-h-96 overflow-y-auto rounded-xl border border-gray-200">
                      <Table>
                        ...
                        <TableBody>
                          ...
                          {/* Revenue total */}
                          <TableRow className="bg-gray-100 hover:bg-gray-100 dark:hover:bg-white/10 font-semibold border-t border-gray-300 dark:border-white/20">
                          ...
                          {/* Net result row */}
                          <TableRow className="bg-[#ebe8fc] dark:bg-[#554fe9]/10 hover:bg-[#ebe8fc] dark:hover:bg-[#554fe9]/10 font-bold border-t-2 border-gray-300 dark:border-white/20">
                            <TableCell colSpan={3} className="text-gray-900 dark:text-white text-sm sm:text-base">
                              <span className="flex items-center gap-2 text-[#554fe9] dark:text-[#7a76f0]">
                                <span className="w-2 h-2 rounded-full bg-current" />
                            ...
                            {preview.closingEntry.lines.map((line, idx) => {
                              ...
                              return (
                                <TableRow
                                  ...
                                  className={isResultAccount ? 'bg-[#ebe8fc] dark:bg-[#554fe9]/10 hover:bg-[#ebe8fc] dark:hover:bg-[#554fe9]/10 font-semibold' : ''}
                                >
                                  <TableCell className="font-mono text-sm text-gray-700 dark:text-gray-300">
                                    {line.accountNumber}
                                  </TableCell>
                                  <TableCell className="text-sm text-gray-700 dark:text-gray-300">
                                    {line.accountName}
                                    {isResultAccount && (
                                      <Badge className="ml-2 bg-[#554fe9]/10 text-[#554fe9] dark:bg-[#554fe9]/20 dark:text-[#7a76f0] border-[#554fe9]/20 text-[10px]">
                                        3300
                                      </Badge>
                                    )}
                                  </TableCell>
                                    ...
                                    <Badge className={`text-[10px] ${
                                      line.accountType === 'REVENUE'
                                        ...
                                        : line.accountType === 'EXPENSE'
                                          ...
                                          : 'bg-[#554fe9]/10 text-[#554fe9] dark:bg-[#554fe9]/20 dark:text-[#7a76f0] border-[#554fe9]/20'
                                    }`}>
                                      {line.accountType === 'REVENUE'
                                        ? (isDanish ? 'Indtægt' : 'Rev.')
                                        : line.accountType === 'EXPENSE'
                                  ...
                                  <TableCell className="text-right font-mono text-sm">
                                    {line.debit > 0 ? (
                                      <span className={isResultAccount ? 'text-[#554fe9] dark:text-[#7a76f0]' : 'text-green-600 dark:text-green-400'}>
                                        {tc(line.debit)}
                                      </span>
                                    ) : (
                                      <span className="text-gray-300 dark:text-gray-600">—</span>
                                  ...
                                  <TableCell className="text-right font-mono text-sm">
                                    {line.credit > 0 ? (
                                      <span className={isResultAccount ? 'text-[#554fe9] dark:text-[#7a76f0]' : 'text-red-600 dark:text-red-400'}>
                                        {tc(line.credit)}
                                      </span>
                                    ) : (
                                      <span className="text-gray-300 dark:text-gray-600">—</span>
                ...
                <>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <Button
                      ...
                      className="gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white font-medium shadow-lg shadow-[#554fe9]/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
                    >
                      <Lock className="h-4 w-4" />
