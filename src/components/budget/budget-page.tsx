...
function getAccountTypeHeaderBg(type: string): string {
  switch (type) {
    ...
    case 'EQUITY':
      return 'bg-[#ebe8fc] dark:bg-[#554fe9]/10';
    case 'REVENUE':
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <PiggyBank className="h-6 w-6 text-[#554fe9]" />
            {isDa ? 'Budgetter' : 'Budgets'}
          </h1>
      ...
      {budgets.length === 0 && !isLoadingBudgets && (
        <Card className="stat-card border-0 shadow-lg dark:border dark:border-white/5">
          <CardContent className="py-16 text-center">
            ...
            <Button onClick={handleOpenCreate} className="gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white">
              <Plus className="h-4 w-4" />
              {isDa ? 'Opret budget' : 'Create Budget'}
            </Button>
          </CardContent>
              ...
              <CardContent className="p-3 sm:p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="h-9 w-9 sm:h-12 sm:w-12 rounded-full stat-icon-primary flex items-center justify-center">
                    <Target className="h-4 w-4 sm:h-6 sm:w-6 text-[#554fe9] dark:text-[#7a76f0]" />
                  </div>
                </div>
          ...
          {detail.entries.length > 0 && (
            <Card className="stat-card border-0 shadow-lg dark:border dark:border-white/5">
              <CardHeader className="pb-3">
                <CardTitle className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                  <Target className="h-5 w-5 text-[#554fe9]" />
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-gray-50 hover:bg-gray-50 dark:hover:bg-white/5">
                        <TableHead className="w-[80px] sticky left-0 bg-gray-50 z-10">
                          #
                        </TableHead>
                        <TableHead className="min-w-[140px] sticky left-[80px] bg-gray-50 z-10">
                          {isDa ? 'Konto' : 'Account'}
                        </TableHead>
        ...
        <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className="bg-[#554fe9] hover:bg-[#4a42d0] text-white gap-2"
            >
