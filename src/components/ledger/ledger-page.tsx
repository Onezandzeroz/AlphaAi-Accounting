...
function getAccountTypeIconColor(type: string): string {
  switch (type) {
    ...
    case 'EQUITY':
      return 'text-[#554fe9] dark:text-[#7a76f0]';
    case 'REVENUE':
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
              ...
              {language === 'da' ? 'Hovedbog' : 'General Ledger'}
            </h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              {language === 'da' ? 'Proveliste for finansielle poster' : 'Trial balance for financial entries'}
            </p>
          </div>
        </div>
  ...
  return (
    <div className="p-4 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button onClick={handleExportCSV} className="gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white font-medium shadow-lg shadow-[#554fe9]/20 transition-all">
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                <BookOpen className="h-5 w-5 text-[#554fe9]" />
