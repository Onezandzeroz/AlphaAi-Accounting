...
export function RecurringEntriesPage({ user }: { user: User }) {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <RefreshCw className="h-6 w-6 text-[#554fe9]" />
            {language === 'da' ? 'Gentagende Posteringer' : 'Recurring Entries'}
          </h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white font-medium shadow-lg shadow-[#554fe9]/20"
          >
        ...
        <CardContent>
          {entries.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Button
                onClick={() => { resetForm(); setIsDialogOpen(true); }}
                className="gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white"
              >
                <Plus className="h-4 w-4" />
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-white">
          <DialogHeader>
            <DialogTitle className="dark:text-white flex items-center gap-2">
              <Repeat className="h-5 w-5 text-[#554fe9]" />
              {editingId
