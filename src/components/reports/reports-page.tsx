      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <BarChart3 className="h-6 w-6 text-[#554fe9]" />
            {language === 'da' ? 'Finansielle Rapporter' : 'Financial Reports'}
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-end">
            <div className="flex-1 grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              <div className="col-span-2 sm:col-span-1">
                <Button
                  onClick={handleRefresh}
                  className="w-full gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white font-medium"
                >
                  {isLoadingIncome || isLoadingBalance ? (
                    <Loader2 className="h-4 w-4 animate-spin" />
                  ) : (
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          {activeTab === 'balance-sheet' && balanceData && (
            <Button
              onClick={handleExportBalanceCSV}
              className="gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white font-medium shadow-lg shadow-[#554fe9]/20 transition-all"
            >
              <Download className="h-4 w-4" />
              {language === 'da' ? 'Eksporter CSV' : 'Export CSV'}
            ...
            <Card className="stat-card border-0 shadow-lg dark:border dark:border-white/5">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className={`gap-1 ${incomeData.netResult >= 0
                ...
                <div className="max-h-[600px] overflow-y-auto rounded-xl border border-gray-200">
                  <Table>
                    ...
                    <TableBody>
                      ...
                      {/* ── Operating Result ── */}
                      <TableRow className="bg-[#ebe8fc] dark:bg-[#554fe9]/10 hover:bg-[#ebe8fc] dark:hover:bg-[#554fe9]/10">
          ...
          {errorBalance ? (
            ...
            <Card className="stat-card border-0 shadow-lg dark:border dark:border-white/5">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                    <Scale className="h-5 w-5 text-[#554fe9]" />
                    {language === 'da' ? 'Balance' : 'Balance Sheet'}
                    <Badge variant="outline" className="text-xs font-normal">
                ...
                <div className="max-h-[600px] overflow-y-auto rounded-xl border border-gray-200">
                  <Table>
                    ...
                    <TableBody>
                      ...
                      <TableRow className="bg-gray-50 hover:bg-gray-50 dark:hover:bg-white/5 font-semibold">
                      ...
                      <TableRow className="bg-[#ebe8fc] dark:bg-[#554fe9]/10 hover:bg-[#ebe8fc] dark:hover:bg-[#554fe9]/10 font-bold">
                        <TableCell className="text-gray-900 dark:text-white text-sm sm:text-base">
                          <span className="flex items-center gap-2 text-[#554fe9] dark:text-[#7a76f0]">
