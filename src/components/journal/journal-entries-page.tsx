      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <FileText className="h-6 w-6 text-[#554fe9]" />
            {isDanish ? 'Finansjournal' : 'Journal Entries'}
          </h1>
        ...
        <Card className="stat-card">
          <CardContent className="p-2.5 sm:p-4">
            <div className="flex items-center justify-between">
              <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-[#554fe9]/10 flex items-center justify-center">
                <BookOpen className="h-4 w-4 sm:h-5 sm:w-5 text-[#554fe9] dark:text-[#7a76f0]" />
              </div>
              <Badge className="bg-[#554fe9]/10 text-[#554fe9] dark:bg-[#554fe9]/20 dark:text-[#7a76f0] text-[10px] sm:text-xs">
                {stats.total}
              </Badge>
            </div>
        ...
        <CardContent className="p-4">
          <div className="flex flex-col lg:flex-row gap-3">
            ...
            <div className="flex items-center gap-2">
              <Filter className="h-4 w-4 text-gray-400 shrink-0 hidden lg:block" />
              <Select value={statusFilter} onValueChange={(v) => setStatusFilter(v as StatusFilter)}>
                <SelectTrigger className="w-36 sm:w-44 bg-gray-50 border-0">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-white">
                  <SelectItem value="ALL">{isDanish ? 'Alle statusser' : 'All Statuses'}</SelectItem>
            ...
            <Input
              ...
              className="w-40 bg-gray-50 border-0"
              placeholder={isDanish ? 'Fra dato' : 'From date'}
            />
            ...
            <Input
              ...
              className="w-40 bg-gray-50 border-0"
              placeholder={isDanish ? 'Til dato' : 'To date'}
            />
              ...
              {filteredEntries.map((entry) => {
                ...
                return (
                  <div key={entry.id}>
                    {/* Entry Header Row */}
                    <div
                      className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 p-4 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors cursor-pointer"
                    ...
                    >
                      ...
                      {/* Reference */}
                      {entry.reference && (
                        <Badge variant="outline" className="text-xs font-mono bg-gray-50 text-gray-600 dark:text-gray-300 shrink-0">
                          {entry.reference}
                        </Badge>
                      )}
                              ...
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button
                                    ...
                                    className="text-gray-400 hover:text-[#554fe9] dark:hover:text-[#7a76f0] h-8 w-8 p-0"
                                  >
                    ...
                    {isExpanded && (
                      <div className="px-4 pb-4 sm:px-14">
                        <div className="rounded-lg border border-gray-200 overflow-hidden">
                          {/* Table Header */}
                          <div className="grid grid-cols-12 gap-2 px-3 py-2 bg-gray-50/50 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                          ...
                          {entry.lines.map((line, idx) => (
                            <div
                              key={line.id || idx}
                              className="grid grid-cols-12 gap-2 px-3 py-2 text-sm border-t border-gray-100/50"
                            >
                              {/* Account */}
                              <div className="col-span-4 sm:col-span-5">
                          ...
                          {/* Totals */}
                          <div className="grid grid-cols-12 gap-2 px-3 py-2 bg-gray-50/30 border-t border-gray-200 font-semibold text-sm">
        ...
        <DialogContent className="bg-white max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader>
            <DialogTitle className="dark:text-white flex items-center gap-2 text-xl">
              <div className="h-9 w-9 rounded-xl bg-[#554fe9]/10 flex items-center justify-center shrink-0">
                <FileText className="h-5 w-5 text-[#554fe9] dark:text-[#7a76f0]" />
              </div>
              {editingEntry
          ...
          <div className="flex-1 overflow-y-auto -mx-6 px-6">
            <div className="space-y-4 py-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="space-y-1.5">
                  <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    <span className="text-gray-400 ml-1">({isDanish ? 'valgfrit' : 'optional'})</span>
                  </Label>
                  <Input
                    value={formReference}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <ArrowRightLeft className="h-4 w-4 text-[#554fe9]" />
                ...
                <Button
                  ...
                  size="sm"
                  onClick={addLine}
                  className="gap-1 text-[#554fe9] border-[#554fe9]/20 hover:bg-[#554fe9]/5 dark:border-[#554fe9]/30 dark:text-[#7a76f0]"
                >
              ...
              <div className="flex items-start gap-2 text-xs text-gray-500 dark:text-gray-400 bg-[#554fe9]/5 dark:bg-[#554fe9]/10 rounded-lg p-2.5 border border-[#554fe9]/10 dark:border-[#554fe9]/20">
                <Info className="h-3.5 w-3.5 shrink-0 mt-0.5 text-[#554fe9] dark:text-[#7a76f0]" />
                <p>
                  {isDanish
              ...
              <div className="space-y-2">
                {/* Desktop header */}
                <div className="hidden sm:grid grid-cols-12 gap-2 px-3 py-1.5 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider bg-gray-50/50 rounded-md">
                    ...
                    <div
                      ...
                      className={`grid grid-cols-1 sm:grid-cols-12 gap-2 sm:gap-2 p-2 sm:p-0 rounded-lg sm:rounded-none transition-colors ${
                        hasBoth
                          ...
                          : 'bg-gray-50 sm:bg-transparent sm:dark:bg-transparent'
                      }`}
                    >
                      {/* Account Select */}
                      ...
                      <div className="sm:col-span-2 sm:px-1">
                        ...
                        <Input
                          ...
                          placeholder="0,00"
                          className="bg-white text-sm h-9 text-right font-mono"
                        />
                      </div>
          ...
          <DialogFooter className="gap-2 sm:gap-0 pt-2 border-t">
            ...
            <Button
              ...
              className="bg-[#554fe9] hover:bg-[#554fe9]/90 text-white gap-1"
            >
              {dialogLoading ? (
                <Loader2 className="h-4 w-4 animate-spin" />
              ) : (
