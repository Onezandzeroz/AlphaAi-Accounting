      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            ...
            {isDanish ? 'Revisionslog' : 'Audit Log'}
          </h1>
                  ...
                  {filteredLogs.map((log) => {
                    ...
                    return (
                      <>
                          ...
                          <TableCell className="hidden md:table-cell">
                            {log.entityId ? (
                              <TooltipProvider>
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <code className="text-xs bg-gray-100 px-1.5 py-0.5 rounded text-gray-600 dark:text-gray-400 font-mono max-w-[120px] truncate inline-block">
                          ...
                          <TableCell className="hidden lg:table-cell">
                            {changes.length > 0 ? (
                              <div className="flex flex-wrap gap-1">
                                ...
                                {changes.length > 3 && (
                                  <Badge variant="outline" className="text-[10px] font-normal bg-gray-100 text-gray-500 border-0">
                                    +{changes.length - 3}
                                  </Badge>
                                )}
                              </div>
                        ...
                        {isExpanded && (
                          <TableRow key={`${log.id}-expanded`} className="bg-gray-50/50/30">
              ...
              {Array.from({ length: Math.min(totalPages, 7) }, (_, idx) => {
                ...
                return (
                  <Button
                    ...
                    className={
                      pageNum === page
                        ? 'bg-[#554fe9] hover:bg-[#554fe9]/90 text-white min-w-[36px]'
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <code className="text-xs bg-gray-100 px-2 py-1 rounded font-mono text-gray-600 dark:text-gray-400 break-all">
                      {detailLog.id}
                    </code>
                  </div>
                  <div>
                ...
                {(() => {
                  ...
                  return (
                    <div>
                      ...
                      <div className="rounded-lg border border-gray-200 overflow-hidden">
                        <div className="grid grid-cols-[1fr_auto_1fr] gap-2 px-3 py-2 bg-gray-100 text-xs font-medium text-gray-500 dark:text-gray-400">
                ...
                {detailLog.changes && (
                  <div>
                    ...
                    <ScrollArea className="max-h-48">
                      <pre className="text-xs bg-gray-100 p-3 rounded-lg font-mono text-gray-600 dark:text-gray-400 whitespace-pre-wrap break-words">
                        {(() => {
                          try {
