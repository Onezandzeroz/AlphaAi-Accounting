        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
              <Landmark className="h-6 w-6 text-[#554fe9]" />
              {language === 'da' ? 'Bankafstemning' : 'Bank Reconciliation'}
            </h1>
    ...
    <div className="p-4 lg:p-8 space-y-6">
            ...
            <CardContent className="p-3 sm:p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="h-9 w-9 sm:h-12 sm:w-12 rounded-full stat-icon-primary flex items-center justify-center">
                  <FileText className="h-4 w-4 sm:h-6 sm:w-6 text-[#554fe9] dark:text-[#7a76f0]" />
                </div>
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={statusFilter} onValueChange={(v) => setStatusFilter(v as 'ALL' | 'MATCHED' | 'UNMATCHED')}>
                <SelectTrigger className="w-[160px] bg-gray-50 border-0">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
      ...
      {data && data.bankStatements.length === 0 && (
        <Card className="stat-card border-0 shadow-lg dark:border dark:border-white/5">
          <CardContent className="py-12 text-center">
            ...
            <Button
              onClick={() => setImportDialogOpen(true)}
              className="gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white font-medium"
            >
              <Upload className="h-4 w-4" />
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
              <FileText className="h-5 w-5 text-[#554fe9]" />
                                  ...
                                  <TableCell>
                                    {line.reconciliationStatus === 'MATCHED' || line.reconciliationStatus === 'MANUAL' ? (
                                      ...
                                      <Button
                                        variant="ghost"
                                        size="sm"
                                        className="h-7 px-2 text-[11px] gap-1 text-[#554fe9] hover:text-[#4a42d0] hover:bg-[#554fe9]/10"
        ...
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <Upload className="h-5 w-5 text-[#554fe9]" />
              {language === 'da'
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div
                ...
                className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-[#554fe9] dark:hover:border-[#7a76f0] transition-colors"
              >
                <input
                  ref={fileInputRef}
                  type="file"
                ...
                {isParsing ? (
                  <div className="flex flex-col items-center gap-2">
                    <Loader2 className="h-8 w-8 text-[#554fe9] animate-spin" />
      ...
      <Dialog open={matchDialogOpen} onOpenChange={setMatchDialogOpen}>
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <Link2 className="h-5 w-5 text-[#554fe9]" />
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <h4 className="text-sm font-semibold text-gray-900 dark:text-white flex items-center gap-1.5">
                  <ArrowUpDown className="h-4 w-4 text-[#554fe9]" />
                  {language === 'da'
                ...
                {isLoadingCandidates ? (
                  <div className="flex items-center justify-center py-8">
                    <Loader2 className="h-6 w-6 text-[#554fe9] animate-spin" />
                  </div>
      ...
      <Card className="info-box-primary">
        <CardContent className="p-4">
          <div className="flex items-start gap-3">
            <Info className="h-5 w-5 shrink-0 mt-0.5 text-[#554fe9] dark:text-[#7a76f0]" />
