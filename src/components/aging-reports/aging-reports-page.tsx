      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <Clock className="h-6 w-6 text-[#554fe9]" />
            {isDanish ? 'Aldersopdeling' : 'Aging Reports'}
          </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-end">
                <div className="space-y-1.5 w-full sm:w-auto">
                  ...
                  <Input
                    ...
                    className="bg-gray-50 border-0 w-full sm:w-48"
                  />
                </div>
              ...
              {report && (
                <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
                  ...
                  <Button
                    ...
                    className="gap-2 bg-[#554fe9] hover:bg-[#4a42d0] text-white font-medium shadow-lg shadow-[#554fe9]/20 transition-all text-sm"
                  >
