...
async function main() {
  ...
  console.log('  📦 Bundler:  Webpack (required for Prisma)');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');

  // Start Next.js dev server on port 3000 with Webpack
  // --webpack is required because Turbopack has module resolution
  // issues with @prisma/client in Next.js 16
